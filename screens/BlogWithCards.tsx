  ...
  return (
    ...
    >
      ...
      <HStack space='md' flexWrap='wrap' mt='$6'>
        <Avatar>
          <Avatar.FallbackText>{username}</Avatar.FallbackText>
          <Avatar.Image
            source={{
              uri: userProfileUri,
            }}
    ...
    <ScrollView>
      ...
      >
        ...
        <HStack justifyContent='space-between' pb='$4'>
          ...
          >
            <Button.Text fontSize='$md' fontStyle='normal'>
              See All
            </Button.Text>
            <Button.Icon as={ArrowRight} w='$5' h='$5' pl='$1' />
          </Button>
        </HStack>
        ...
        >
          <Button.Text fontSize='$sm' fontStyle='normal'>
            See All
          </Button.Text>
          <Button.Icon as={ArrowRight} w='$4' h='$4' pl='$1' />
        </Button>
      </Box>
    </ScrollView>
  );
